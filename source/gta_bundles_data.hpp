...
static const BundleDef BUNDLES[] = {
    { "Bundling A", "Money & Health",      BUNDLE_A_NAMES, sizeof(BUNDLE_A_NAMES)/sizeof(BUNDLE_A_NAMES[0]) },
    { "Bundling B", "Weapons Pack",        BUNDLE_B_NAMES, sizeof(BUNDLE_B_NAMES)/sizeof(BUNDLE_B_NAMES[0]) },
    { "Bundling C", "Wanted Control",      BUNDLE_C_NAMES, sizeof(BUNDLE_C_NAMES)/sizeof(BUNDLE_C_NAMES[0]) },
    { "Bundling D", "Traffic Mayhem",      BUNDLE_D_NAMES, sizeof(BUNDLE_D_NAMES)/sizeof(BUNDLE_D_NAMES[0]) },
};
